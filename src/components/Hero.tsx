...
const Hero = ({ onOpenForm }: HeroProps) => {
  return (
    <section id="home" className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-hero -z-10 animate-pulse" style={{ animationDuration: "4s" }} />
      <div className="absolute inset-0 bg-gradient-to-br from-secondary/20 via-transparent to-primary/20 -z-10" />
      
      {/* Floating Orbs */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-secondary/30 rounded-full blur-3xl animate-pulse" style={{ animationDuration: "3s" }} />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-primary/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: "5s", animationDelay: "1s" }} />
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-heading font-bold text-primary-foreground mb-6 leading-tight animate-fade-in-up">
            Your Gateway to
            <span className="block bg-gradient-to-r from-secondary via-primary to-secondary bg-clip-text text-transparent mt-2 animate-glow">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            <Button 
              onClick={onOpenForm}
              size="lg" 
              className="bg-gradient-cta hover:shadow-custom-glow hover:scale-105 transition-all duration-300 font-heading font-bold text-base md:text-lg px-10 py-7 animate-glow shadow-lg"
            >
              Register Online
            </Button>
            <Button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto animate-scale-in" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="bg-gradient-to-br from-primary-foreground/15 to-primary-foreground/5 backdrop-blur-md rounded-2xl p-8 border-2 border-primary-foreground/30 hover:border-secondary/50 transition-all duration-300 hover:scale-105 hover:shadow-custom-glow group">
              ...
              <div className="text-4xl font-heading font-bold text-primary-foreground mb-2">1000+</div>
